...
class BlockingRepository {
    ...
    suspend fun blockUser(request: BlockedUserCreateRequest): Result<BlockedUserDetail> =
    ...
    suspend fun getBlockedUsers(limit: Int? = null, offset: Int? = null): Result<PaginatedBlockedUsers> =
